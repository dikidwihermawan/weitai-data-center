    ...
    <>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <Link href="/" className="flex ms-2 md:me-24">
                <img src="/logo_full.jpg" className="h-8 me-3" alt="WEITAI" />
      ...
      <div className="grid grid-cols-12 max-h-screen">
        <div className="col-span-2">
          <div
            id="logo-sidebar"
            className="sticky top-0 left-0 z-40 h-screen py-4 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            aria-label="Sidebar"
          >
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
              <ul className="space-y-6 font-medium text-xs">
                <li>
                  <a
                    href="/"
        ...
        <div className="col-span-10 px-2">{children}</div>
      </div>
    </>
  );
}
